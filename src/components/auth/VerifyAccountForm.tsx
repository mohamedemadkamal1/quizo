...
import type { useVerifyAccountScreen } from '@/hooks/auth/useVerifyAccountScreen';

type VerifyAccountFormProps = {
  screen: ReturnType<typeof useVerifyAccountScreen>;
};

export function VerifyAccountForm({ screen }: VerifyAccountFormProps) {
